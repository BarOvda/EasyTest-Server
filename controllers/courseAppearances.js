...
exports.updateCourseApp = async (req, res, next) => { //TODO : Test
  ...
  try {
    ...
    if (req.body.examsDateA) loadedCourse.exams.exam = req.body.exam;
    if (req.body.examsDateB) loadedCourse.exams.remake = req.body.remake;
    if (req.body.isExamWithMatearials) loadedCourse.exams.withMaterials = req.body.withMaterials;
    if (req.body.examDuration) loadedCourse.exams.duration = req.body.duration;
